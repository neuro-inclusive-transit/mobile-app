...
>
  <stackLayout class="main-layout">
    <label
      text="Von welchem Zeitpunkt ist deine Reise abhängig?"
      textWrap={true}
      class="fs-l fw-bold m-b-xl"
    />
    <BigButton
      icon="login"
      label="Ankunftszeit festlegen"
      on:tap={onArrivalTime}
      class="m-b-m"
    />
    <BigButton
      icon="logout"
      label="Zeit zum losgehen festlegen"
      on:tap={onDepartureTime}
    />
  </stackLayout>
</SelectionStep>
